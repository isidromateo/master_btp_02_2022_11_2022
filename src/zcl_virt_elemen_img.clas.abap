CLASS zcl_virt_elemen_img DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_VIRT_ELEMEN_IMG IMPLEMENTATION.


  METHOD if_sadl_exit_calc_element_read~calculate.
    DATA lt_original_data TYPE STANDARD TABLE OF z_c_travel_img WITH DEFAULT KEY.
