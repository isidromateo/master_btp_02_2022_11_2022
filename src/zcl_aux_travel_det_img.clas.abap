CLASS zcl_aux_travel_det_img DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  PUBLIC SECTION.
    TYPES: tt_travel_reported      TYPE TABLE FOR REPORTED z_i_travel_img,
           tt_booking_reported     TYPE TABLE FOR REPORTED z_i_booking_img,
           tt_supplements_reported TYPE TABLE FOR REPORTED z_i_booksuppl_img.
...
CLASS ZCL_AUX_TRAVEL_DET_IMG IMPLEMENTATION.
  ...
  METHOD calculate_price.
    ...
    MODIFY ENTITIES OF z_i_travel_img
           ...
           lt_read_travel ( travel_id            = ls_travel_bo-travel_id
